export const globalConstants = {
    ...
    POM_HPS_CAP_3SHAMANS: 100,
    RENEW_CAP_3SHAMANS: 0.70,
    SHIELD_MINUTE_CAP_3SHAMANS: 2.4,
    TANK_RECEIVED_PERCENT_CAP_PRIEST_3SHAMANS:0.19,

    //萨满
    G2_SHAMAN_PERCENT: 0.205,
    G4_SHAMAN_PERCENT: 0.25,
    SHAMAN_HEALING_MAX: 20,
    //萨满(3萨)
    G2_SHAMAN_PERCENT_3SHAMANS: 0.185,
    G4_SHAMAN_PERCENT_3SHAMANS: 0.22,
    ...
    TANK_HEALING_PERCENT_CAP:0.73,
    TANK_RECEIVED_PERCENT_CAP_PALADIN:0.19,

    //骑(3萨)
    PALADIN_PERCENT_3SHAMANS: 0.095,
    PALADIN_HEALING_MAX_3SHAMANS: 10,
    TANK_EMERGENCY_CAP_3SHAMANS: 0.37,
    TANK_HEALING_PERCENT_CAP_3SHAMANS:0.74,
